#!/bin/bash
#SBATCH --job-name=03b_asset_RS_between              # Job name
...
#SBATCH --output=./results/slurm_files/slurm_03b_between_asset_RS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_03b_between_asset_RS.err      # where to write slurm error
