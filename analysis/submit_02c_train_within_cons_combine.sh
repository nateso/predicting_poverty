#!/bin/bash
#SBATCH --job-name=02c_cons_within               # Job name
...
#SBATCH --output=./results/slurm_files/slurm_02c_within_cons.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_02c_within_cons.err      # where to write slurm error
