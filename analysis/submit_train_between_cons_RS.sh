#!/bin/bash
#SBATCH --job-name=RS_cons_between               # Job name
...
#SBATCH --output=./results/slurm_files/slurm_between_cons_RS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_between_cons_RS.err      # where to write slurm error
