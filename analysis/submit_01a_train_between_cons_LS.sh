#!/bin/bash
#SBATCH --job-name=01a_cons_LS_between               # Job name
...
#SBATCH --output=./results/slurm_files/slurm_01a_between_cons_LS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_01a_between_cons_LS.err      # where to write slurm error
