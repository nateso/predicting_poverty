...
#SBATCH --output=./slurm_files/slurm_between_asset_RS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./slurm_files/slurm_between_asset_RS.err      # where to write slurm error
