...
#SBATCH --output=./slurm_files/slurm_between_asset_LS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./slurm_files/slurm_between_asset_LS.err      # where to write slurm error
