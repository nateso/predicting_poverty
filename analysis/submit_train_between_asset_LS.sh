#!/bin/bash
#SBATCH --job-name=LS_asset_between   # Job name
...
#SBATCH --output=./results/slurm_files/slurm_between_asset_LS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_between_asset_LS.err      # where to write slurm error
