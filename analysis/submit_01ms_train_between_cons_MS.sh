#!/bin/bash
#SBATCH --job-name=01ms_cons_MS_between               # Job name
...
#SBATCH --output=./results/slurm_files/slurm_01ms_between_cons_MS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_01ms_between_cons_MS.err      # where to write slurm error
...
model_name='between_cons_MS'
cv_object_name='between_cons_MS_cv'
