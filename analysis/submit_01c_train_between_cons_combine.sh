#!/bin/bash
#SBATCH --job-name=01c_cons_between              # Job name
...
#SBATCH --output=./results/slurm_files/slurm_01c_between_cons.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_01c_between_cons.err      # where to write slurm error
...
object_name='between_cons'
target_var='avg_log_mean_pc_cons_usd_2017'
ls_cv_pth='results/model_objects/between_cons_MS_cv.pkl'
