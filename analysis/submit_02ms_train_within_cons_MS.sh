#!/bin/bash
#SBATCH --job-name=02ms_cons_MS_within               # Job name
...
#SBATCH --output=./results/slurm_files/slurm_02ms_within_cons_MS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_02ms_within_cons_MS.err      # where to write slurm error
...
model_name='within_cons_MS'
cv_object_name='within_cons_MS_cv'
