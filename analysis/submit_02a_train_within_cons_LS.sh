...
#SBATCH --output=./results/slurm_files/slurm_02a_within_cons_LS.out     # where to write output, %x give job name, %j names job id
#SBATCH --error=./results/slurm_files/slurm_02a_within_cons_LS.err      # where to write slurm error
...
model_name='within_cons_LS'
cv_object_name='within_cons_LS_cv'
