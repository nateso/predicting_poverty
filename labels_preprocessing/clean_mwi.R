...
mw1_cons %<>% 
  ...
  mutate(cons_pc_lcu_2017 = pcrexpagg * 2.0481145) %>%  # 2.0481145 is the value to inflate 2013 LCU to 2017 LCU.
  mutate(cons_pc_usd_2017 = cons_pc_lcu_2017 / (241.930526733398 * 365)) %>% 
...
mw3 <- mw3_house %>% 
  ...
  relocate(country, year, wave, case_id, hh_size, adulteq, cons_pc_lcu_2017, cons_pc_usd_2017) %>% 
  select(-y3_hhid)
...
##### save data #####
#...............................................................................  
write.csv(mw_short_panel,"../../Data/processed/mwi_short_labels.csv")
write.csv(mw_short_panel_attr,"../../Data/processed/mwi_short_labels_attr.csv")
write.csv(mw_long_panel,"../../Data/processed/mwi_long_labels.csv")
write.csv(mw_long_panel_attr,"../../Data/processed/mwi_long_labels_attr.csv")
