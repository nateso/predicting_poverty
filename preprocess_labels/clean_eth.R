...
#### save data ####
#*******************************************************************************
write.csv(long_panel,"../../Data/lsms/processed/eth_labels_long.csv", row.names = F)
write.csv(long_panel_attr,"../../Data/lsms/processed/eth_labels_long_attr.csv", row.names = F)
write.csv(short_panel,"../../Data/lsms/processed/eth_labels_short.csv", row.names = F)
write.csv(short_panel_attr,"../../Data/lsms/processed/eth_labels_short_attr.csv", row.names = F)
