...
# save data
write.csv(short_panel,"../../Data/lsms/processed/nga_short_labels.csv", row.names = F)
write.csv(long_panel,"../../Data/lsms/processed/nga_long_labels.csv", row.names = F)
write.csv(short_panel_attr, "../../Data/lsms/processed/nga_short_labels_attr.csv", row.names = F)
write.csv(long_panel_attr,"../../Data/lsms/processed/nga_long_labels_attr.csv", row.names =F)
